...
# plan-09-doc-generation Specification

## Purpose

Define the doc-generation plan as a prioritized backlog of documentation tasks:
enrich docstrings, install mkdocstrings-python, configure in zensical.toml, add
directives, integrate with CI, and verify end-to-end with `make docs-build`.
