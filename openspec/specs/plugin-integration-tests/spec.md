...
# plugin-integration-tests Specification

## Purpose

Define integration tests for the `spdx-markdown-formatter` plugin that verify
cold-import behavior, circular-import avoidance, and isinstance checks —
concerns that span module-loading infrastructure rather than individual method
behavior.
