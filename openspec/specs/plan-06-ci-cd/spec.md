...
# plan-06-ci-cd Specification

## Purpose

Define the CI/CD plan marking internal implementation as done while scoping the
PyPI trusted-publisher setup as an external post-release task.
